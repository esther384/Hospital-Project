...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onAppointmentsSnapshot((err, data) => {
      ...
      // sort by createdAt or scheduledAt if present
    ...
    <div className="max-w-7xl mx-auto pb-10">
      <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4 animate-fade-in-up">
        ...
        <div className="flex space-x-3">
          <button className="bg-white border border-slate-200 text-slate-700 font-bold px-4 py-2 rounded-xl hover:bg-slate-50 transition-colors shadow-sm">
            Export Report
          </button>
          <button className="bg-primary hover:bg-primary-light text-white font-bold px-4 py-2 rounded-xl transition-colors shadow-md">
            New Doctor
          </button>
        </div>
      </div>
      ...
      <div
        className="grid md:grid-cols-4 gap-6 mb-10 animate-fade-in-up"
      ...
      >
        {[
          ...
          <div
            key={i}
            className="bg-white p-6 rounded-[1.5rem] shadow-sm hover:shadow-lg transition-shadow border border-slate-100 group"
          >
      ...
      <div
        className="grid lg:grid-cols-3 gap-8 animate-fade-in-up"
      ...
      >
        ...
        <div className="lg:col-span-2 bg-white rounded-[1.5rem] shadow-sm border border-slate-100 flex flex-col overflow-hidden">
          <div className="p-6 border-b border-slate-50 flex justify-between items-center bg-slate-50/30">
            ...
            <button className="text-secondary font-bold text-sm hover:text-secondary-dark">
              View All
            </button>
          </div>
